...
#     set_property IOSTANDARD LVCMOS33 [get_ports {led[10]}]
 set_property PACKAGE_PIN U3 [get_ports {key_led[0]}]
     set_property IOSTANDARD LVCMOS33 [get_ports {key_led[0]}]
 set_property PACKAGE_PIN P3 [get_ports {key_led[1]}]
     set_property IOSTANDARD LVCMOS33 [get_ports {key_led[1]}]
 set_property PACKAGE_PIN N3 [get_ports {key_led[2]}]
     set_property IOSTANDARD LVCMOS33 [get_ports {key_led[2]}]
 set_property PACKAGE_PIN P1 [get_ports {key_led[3]}]
     set_property IOSTANDARD LVCMOS33 [get_ports {key_led[3]}]
 set_property PACKAGE_PIN L1 [get_ports {key_led[4]}]
...
# set_property PACKAGE_PIN W19 [get_ports _volDOWN]
